...
- **Callsign:** {callsign}
- **Role:** {short job title, e.g. "Web App Developer" — the job, not the name; survives /rename}
- **Repo:** `{repo}/`
...
- No secret env vars in client bundles.
- All data access via API client, never direct database.
